...
const apiExamples: ApiExample[] = [
  ...
  },
  {
    ...
    body: '9446217e-49e8-49f9-84dc-822ed8df969b'
  },
  {
    name: 'Get List by ID',
    type: 'lists',
    action: 'getOne',
    body: '1' // Replace with a valid list ID
  }
]
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  {type === 'sites' && (
                    <option value="getByUserId">Get By User ID</option>
                  )}
                  {type === 'lists' && <option value="getListsByUserId">Get Lists By User ID</option>} {/* Nuova opzione */}
                </select>
              </div>
              {(action === 'getOne' || action === 'create' || action === 'getByUserId' || action === 'getListsByUserId') && (
              <div>
                ...
                <textarea
                  ...
                  placeholder={action === 'getOne'
                    ? 'Enter ID'
                    : action === 'getByUserId' || action === 'getListsByUserId'
                    ? 'Enter User ID'
                    : 'Enter JSON body'
                  }
                />
